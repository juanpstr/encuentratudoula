...
export const allDoulas: Doula[] = [
  ...
  },
  {
    ...
    languages: ['Español', 'Portugués', 'Inglés', 'Libanés'],
    location: {
      address: 'Lisboa',
      city: 'Lisboa',
      country: 'Portugal',
  ...
  // Nuevas doulas agregadas
  {
    ...
    profile_image: '/doulas/Alexandra.jpg',
    gallery_images: [],
    is_verified: true,
    is_active: true,
  ...
  {
    id: '10',
    slug: 'kaila-arias-carreno',
    name: 'Kaila Arias Carreño',
    email: 'kaila.arias@encuentratudoula.com',
    phone: '+57 3165288832',
    nationality: 'Colombiana',
    ...
    profile_image: '/doulas/Kaila.jpg',
    gallery_images: [],
    is_verified: true,
    is_active: true,
